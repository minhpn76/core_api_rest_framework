...
try:
    try:
        from mind_core_oauth.compat import oauth2_provider
        from mind_core_oauth.compat.oauth2_provider import oauth2
    except ImportError:
    ...
    try:
        from mind_core.compat import oauth2_provider
        from mind_core.compat.oauth2_provider import oauth2  # NOQA
    except ImportError:
        # if oauth2 module can not be imported, skip the tests,
        # because models have not been initialized.
        oauth2_provider = None
