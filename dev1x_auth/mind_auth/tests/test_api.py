...
from mind_auth.registration.views import RegisterView
from mind_auth.registration.app_settings import register_permission_classes
...
class APIBasicTests(TestsMixin, TestCase):
    ...
    REGISTRATION_VIEW = 'mind_auth.runtests.RegistrationView'
    ...
    @override_settings(mind_auth_REGISTER_PERMISSION_CLASSES=(CustomPermissionClass,))
