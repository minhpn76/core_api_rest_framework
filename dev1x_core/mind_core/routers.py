...
from mind_core.reverse import reverse
from mind_core.schemas import SchemaGenerator
from mind_core.schemas.views import SchemaView
from mind_core.settings import api_settings
from mind_core.urlpatterns import format_suffix_patterns
...
class SimpleRouter(BaseRouter):
    ...
    def get_lookup_regex(self, viewset, lookup_prefix=''):
        ...
        Note that lookup_prefix is not used directly inside REST mind_core
