...
from mind_core import VERSION, exceptions, serializers, status
from mind_core.compat import (
    INDENT_SEPARATORS, LONG_SEPARATORS, SHORT_SEPARATORS, coreapi, coreschema,
    pygments_css, yaml
)
from mind_core.exceptions import ParseError
from mind_core.request import is_form_media_type, override_method
from mind_core.settings import api_settings
from mind_core.utils import encoders, json
from mind_core.utils.breadcrumbs import get_breadcrumbs
from mind_core.utils.field_mapping import ClassLookupDict
...
class HTMLFormRenderer(BaseRenderer):
    ...
    format = 'form'
    charset = 'utf-8'
    template_pack = 'mind_core/vertical/'
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    media_type = 'text/html'
    format = 'api'
    template = 'mind_core/api.html'
    filter_template = 'mind_core/filters/base.html'
    code_style = 'emacs'
    charset = 'utf-8'
    ...
    def render_form_for_serializer(self, serializer):
        ...
        return form_renderer.render(
            ...
            {'style': {'template_pack': 'mind_core/horizontal'}}
        )
...
class DocumentationRenderer(BaseRenderer):
    ...
    format = 'html'
    charset = 'utf-8'
    template = 'mind_core/docs/index.html'
    error_template = 'mind_core/docs/error.html'
    code_style = 'emacs'
    ...
    def get_context(self, data, request):
        return {
            ...
            'lang_htmls': ["mind_core/docs/langs/%s.html" % l for l in self.languages],
            'lang_intro_htmls': ["mind_core/docs/langs/%s-intro.html" % l for l in self.languages],
            'code_style': pygments_css(self.code_style),
            'request': request
        }
