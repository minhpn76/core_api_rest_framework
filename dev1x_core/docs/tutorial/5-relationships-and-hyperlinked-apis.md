...
Note that settings in REST framework are all namespaced into a single dictionary setting, named `mind_core`, which helps keep them well separated from your other project settings.
