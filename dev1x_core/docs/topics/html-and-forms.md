...
**views.py**:
    ...
    from mind_core.renderers import TemplateHTMLRenderer
...
*This is the default template pack.*
    ...
    <form action="{% url 'login' %}" method="post" novalidate>
        {% csrf_token %}
        {% render_form serializer template_pack='mind_core/vertical' %}
...
A compact form style that presents all the controls inline.
    ...
    <form class="form-inline" action="{% url 'login' %}" method="post" novalidate>
        {% csrf_token %}
        {% render_form serializer template_pack='mind_core/inline' %}
        <button type="submit" class="btn btn-default">Sign in</button>
    </form>
