...
If you include fully-qualified URLs in your resource output, they will be 'urlized' and made clickable for easy browsing by humans.  The `mind_core` package includes a [`reverse`][drfreverse] helper for this purpose.
...
To customize the default style, create a template called `mind_core/api.html` that extends from `mind_core/base.html`.  For example:

**templates/mind_core/api.html**

    {% extends "mind_core/base.html" %}
...
To add branding and customize the look-and-feel of the login template, create a template called `login.html` and add it to your project, eg: `templates/mind_core/login.html`.  The template should extend from `mind_core/login_base.html`.

You can add your site name or branding by including the branding block:

    {% extends "mind_core/login_base.html" %}
