...
```python
from mind_core.schemas import get_schema_view
...
* Instantiate `ManualSchema` on your view, providing the Core API `Fields` for
  the view explicitly:
        ...
        from mind_core.views import APIView
        from mind_core.schemas import ManualSchema
...
May be used to pass the set of renderer classes that can be used to render the API root endpoint.
    ...
    from mind_core.schemas import get_schema_view
    from mind_core.renderers import JSONOpenAPIRenderer
...
**views.py:**
    ...
    from mind_core.decorators import api_view, renderer_classes
    from mind_core import renderers, response, schemas
...
representation.
    ...
    import coreapi
    from mind_core.decorators import api_view, renderer_classes
    from mind_core import renderers, response
