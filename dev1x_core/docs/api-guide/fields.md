...
**Note:** The serializer fields are declared in `fields.py`, but by convention you should import them using `from mind_core import serializers` and refer to fields as `serializers.<FieldName>`.
