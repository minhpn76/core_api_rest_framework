...
This validator should be applied to *serializer fields*, like so:
    ...
    from mind_core.validators import UniqueValidator
...
The validator should be applied to *serializer classes*, like so:
    ...
    from mind_core.validators import UniqueTogetherValidator
...
The validator should be applied to *serializer classes*, like so:
    ...
    from mind_core.validators import UniqueForYearValidator
