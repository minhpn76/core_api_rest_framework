...
using the `APIView` class-based views.
    ...
    from mind_core.renderers import JSONRenderer
...
**.template**: `'mind_core/horizontal/form.html'`
...
The following is an example plaintext renderer that will return a response with the `data` parameter as the content of the response.
    ...
    from mind_core import renderers
...
Modify your REST framework settings.
    ...
    mind_core = {
        'DEFAULT_PARSER_CLASSES': (
            'mind_core_yaml.parsers.YAMLParser',
        ),
        'DEFAULT_RENDERER_CLASSES': (
            'mind_core_yaml.renderers.YAMLRenderer',
        ),
    }
...
Modify your REST framework settings.
    ...
    mind_core = {
        'DEFAULT_PARSER_CLASSES': (
            'mind_core_xml.parsers.XMLParser',
        ),
        'DEFAULT_RENDERER_CLASSES': (
...
Modify your REST framework settings.
    ...
    mind_core = {
        'DEFAULT_RENDERER_CLASSES': (
            'mind_core_jsonp.renderers.JSONPRenderer',
        ),
    }
...
To avoid having a file streamed without a filename (which the browser will often default to the filename "download", with no extension), we need to use a mixin to override the `Content-Disposition` header. If no filename is provided, it will default to `export.xlsx`. For example:
    ...
    from mind_core.viewsets import ReadOnlyModelViewSet
