...
Configuration for REST framework is all namespaced inside a single Django setting, named `mind_core`.
...
Default: `'mind_core.negotiation.DefaultContentNegotiation'`

#### DEFAULT_SCHEMA_CLASS

A view inspector class that will be used for schema generation.

Default: `'mind_core.schemas.AutoSchema'`
...
Default: `'mind_core.views.get_view_name'`
...
Default: `'mind_core.views.get_view_description'`
...
Default: `'mind_core.views.exception_handler'`
