...
from mind_core import (
    filters, generics, pagination, permissions, serializers
)
from mind_core.compat import coreapi, coreschema, get_regex_pattern, path
from mind_core.decorators import action, api_view, schema
from mind_core.request import Request
from mind_core.routers import DefaultRouter, SimpleRouter
from mind_core.schemas import (
    AutoSchema, ManualSchema, SchemaGenerator, get_schema_view
)
from mind_core.schemas.generators import EndpointEnumerator
from mind_core.schemas.inspectors import field_to_schema
from mind_core.schemas.utils import is_list_view
from mind_core.test import APIClient, APIRequestFactory
from mind_core.utils import formatting
from mind_core.views import APIView
from mind_core.viewsets import GenericViewSet, ModelViewSet
...
class TestAutoSchema(TestCase):
    ...
    def test_set_custom_inspector_class_via_settings(self):
        with override_settings(mind_core={'DEFAULT_SCHEMA_CLASS': 'tests.test_schemas.CustomViewInspector'}):
            view = APIView()
            assert isinstance(view.schema, CustomViewInspector)
