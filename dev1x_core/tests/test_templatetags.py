...
from mind_core.compat import coreapi, coreschema
from mind_core.relations import Hyperlink
from mind_core.templatetags import mind_core
from mind_core.templatetags.mind_core import (
...
class Issue1386Tests(TestCase):
    ...
    def test_smart_urlquote_wrapper_handles_value_error(self):
        ...
        old = mind_core.smart_urlquote
        mind_core.smart_urlquote = mock_smart_urlquote
        assert mind_core.smart_urlquote_wrapper('test') is None
        mind_core.smart_urlquote = old
...
class URLizerTests(TestCase):
    ...
    def test_template_render_with_autoescape(self):
        ...
        """
        template = Template("{% load mind_core %}{{ content|urlize_quoted_links }}")
    ...
    def test_template_render_with_noautoescape(self):
        ...
        """
        template = Template("{% load mind_core %}"
