...
from mind_core import filters, generics, serializers
from mind_core.compat import coreschema
...
class SearchFilterTests(TestCase):
    ...
    def test_search_with_nonstandard_search_param(self):
        with override_settings(mind_core={'SEARCH_PARAM': 'query'}):
...
class OrderingFilterTests(TestCase):
    ...
    def test_ordering_with_nonstandard_ordering_param(self):
        with override_settings(mind_core={'ORDERING_PARAM': 'order'}):
            reload_module(filters)
