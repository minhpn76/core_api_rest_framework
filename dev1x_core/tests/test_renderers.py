...
from mind_core import permissions, serializers, status
from mind_core.compat import MutableMapping, coreapi
from mind_core.decorators import action
...
from mind_core.routers import SimpleRouter
from mind_core.settings import api_settings
from mind_core.test import APIRequestFactory, URLPatternsTestCase
from mind_core.utils import json
from mind_core.views import APIView
from mind_core.viewsets import ViewSet
...
urlpatterns = [
    ...
    url(r'^api', include('mind_core.urls', namespace='mind_core'))
]
