...
from mind_core import exceptions, fields, relations, serializers
from mind_core.compat import Mapping, unicode_repr
from mind_core.fields import Field
...
class TestDefaultOutput:
    ...
    def test_default_for_multiple_dotted_source(self):
        ...
        # mind_core.fields.get_attribute() (#5880)
